      ...
      <table className="w-full">
        <thead>
          <tr className="uppercase text-sm text-primary dark:text-light border-b border-primary dark:border-light">
            ...
            <th className="px-6 py-4">Usuń</th>
          </tr>
        </thead>
            ...
            >
              ...
              <td className="px-4 sm:px-6 py-4">
                <input
                  ...
                  className="w-16 px-2 py-1 border rounded-md focus:ring-light dark:focus:ring-gray-600 dark:bg-gray-800 text-gray-900 dark:text-gray-100"
                />
              </td>
              <td className="px-4 sm:px-6 py-4">
                <button
                  ...
                  className="text-primary dark:text-red-400 border-primary dark:border-red-400 p-2 rounded hover:bg-lighter dark:hover:bg-gray-700"
                >
