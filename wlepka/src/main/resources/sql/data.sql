...
VALUES ('Toxic', 'Toksyczny gołąb.', 10, 85, '/stickers/toxic.jpg', CURRENT_TIMESTAMP, 'admin', NULL, NULL);

INSERT INTO products(name, description, price, popularity, image_url, created_at, created_by, updated_at, updated_by)
VALUES ('Angels', 'Szalone aniołki.', 8, 70, '/stickers/angels.jpg', CURRENT_TIMESTAMP, 'admin', NULL, NULL);
